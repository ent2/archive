...
Lang.Menus = {
    ...
    "file_upload_warn_desc_table": "Data containing violent and cruel contents, sexual contents, offensive and violent contents,<br>data that may infringe on personal information of one or others, copyrighted data prohibited from unauthorized use",
...
Lang.Workspace = {
    ...
    "file_size_exceeded": "<br>The variable or list has<br>too much data to upload.",
...
Lang.Helper = {
    ...
    "get_value_from_table": "The selected attribute value of the entered row in the selected table. Instead of an attribute value block, you can also combine a value block (meaning a row).",
    "get_value_from_last_row": "The selected attribute value of the last row in the selected table. Instead of an attribute value block, you can also combine a value block (meaning a row).",
...
Lang.template = {
    ...
    "set_value_from_table": "Change %3 in the table %1 %2 th row to %4 %5",
    "get_table_count": "number of %2 in table %1",
    "get_value_from_table": "value of %3 in %2 th row of table %1",
    "get_value_from_last_row": "%2 value of the last row in table %1",
    "calc_values_from_table": "%3 of %2 in table %1",
    "open_table_chart": "Open the chart %2 of the table %1 %3",
    "close_table_chart": "Close the table chart %1",
    "variableAddButton": "%1",
    "listAddButton": "%1",
